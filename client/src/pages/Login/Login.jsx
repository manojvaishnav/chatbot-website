...
const Login = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`${process.env.REACT_APP_API_URL}/api/v1/auth/login`, formdata)
            ...
            <Center>
              {
                isLoading ? <Spinner /> : <Stack spacing={4}>
                  ...
                  <Link to={'/register'}>
                    <Text fontSize={{ base: 'md', sm: 'md' }} cursor={'pointer'}>Forgot Password?</Text>
                  </Link>
                </Stack> */}
                      <Button
                        bg="purple.400"
                      ...
                      <Stack direction="row" justifyContent="space-between" w="100%">
                        <Link to={'/register'}>
                          <Text fontSize={{ base: 'md', sm: 'md' }} cursor={'pointer'}>Not a member?</Text>
                        </Link>
                      </Stack>
                    </VStack>
                  </VStack>
